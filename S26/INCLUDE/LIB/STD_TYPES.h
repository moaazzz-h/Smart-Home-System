...
typedef signed char            s8;     // 1 byte = 8 bits s
...
typedef float                  f32;    // 4 bytes = 32 bits s32


typedef double                 f64;    // 8 bytes = 64 bits s64


typedef long double            f128;   // 16 byte = 128 bits s128
